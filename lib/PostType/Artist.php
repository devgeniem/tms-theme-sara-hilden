...
namespace TMS\Theme\Sara_Hilden\PostType;
 ...
 * Artist CPT
 *
 * @package TMS\Theme\Sara_Hilden\PostType
 */
class Artist implements PostType {
    ...
    public function __construct() {
        $this->description = _x( 'Artists', 'theme CPT', 'tms-theme-sara_hilden' );
    }
    ...
    private function register() {
        $labels = [
            'name'                  => _x( 'Artists', 'theme CPT', 'tms-theme-sara_hilden' ),
